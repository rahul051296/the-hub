...
?>
    ...
    <body>
        <nav class="navbar navbar-expand-md bg-custom-2 navbar-dark navbar-fixed">
            <!-- Brand -->
    ...
    <span class="navbar-toggler-icon"></span>
        ...
        <article id="cover">
            <div class="container">
                <div class="col-4">
                    <img src=<?php echo "'img/profile_pic/01.jpg'" ?> width="200px" class="img-responsive img-rounded" id="profile-head" />
<!--
